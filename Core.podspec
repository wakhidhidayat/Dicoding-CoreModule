...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Wahid Hidayat" => "wshidayat38@gmail.com" }
  # Or just: spec.author    = "Wahid Hidayat"
  # spec.authors            = { "Wahid Hidayat" => "wshidayat38@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/wakhidhidayat7"
  ...
  spec.source       = { :git => "https://github.com/wakhidhidayat/Dicoding-CoreModule.git", :tag => "#{spec.version}" }
